...
#define MFCVSPI_NSS_PIN               GPIO_Pin_6
#define MFCVSPI_NSS_GPIO_PORT         GPIOB
#define MFCVSPI_SCK_PIN               GPIO_Pin_4 
#define MFCVSPI_SCK_GPIO_PORT         GPIOB              
#define MFCVSPI_MISO_PIN              GPIO_Pin_5                 
#define MFCVSPI_MISO_GPIO_PORT        GPIOB                    
#define MFCVSPI_MOSI_PIN              GPIO_Pin_0              
#define MFCVSPI_MOSI_GPIO_PORT        GPIOF                      
#define MFCVSPI_NRSTPD_PIN            GPIO_Pin_1              
#define MFCVSPI_NRSTPD_GPIO_PORT      GPIOF  
