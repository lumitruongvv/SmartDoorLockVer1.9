...
void LED_Notifi_Init_Success(uint8_t numberloop)
{
  ...
  {
    LED_Dispaly(0x00, 0x01); delay_ms(50);
    LED_Dispaly(0x00, 0x02); delay_ms(50);
    LED_Dispaly(0x00, 0x04); delay_ms(50);
    LED_Dispaly(0x00, 0x20); delay_ms(50);
    LED_Dispaly(0x01, 0x00); delay_ms(50);
    LED_Dispaly(0x08, 0x00); delay_ms(50);
    LED_Dispaly(0x04, 0x00); delay_ms(50);
    LED_Dispaly(0x02, 0x00); delay_ms(50);
    LED_Dispaly(0x00, 0x40); delay_ms(50);
    LED_Dispaly(0x00, 0x08); delay_ms(50);
    LED_Dispaly(0x00, 0x01); delay_ms(50);
