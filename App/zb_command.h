#ifndef _ZB_COMMAND_H_
#define _ZB_COMMAND_H_
...
typedef void (*ZB_CommandHandle_t)(u8 type,u8* buff,u8 len);

typedef struct ZB_CommandInfo_t
{
    u8 cmdId;
    ZB_CommandHandle_t cmdHandle;
}ZB_CommandInfo_t;
